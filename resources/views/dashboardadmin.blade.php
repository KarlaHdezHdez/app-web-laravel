      ...
      <div class="navbar-collapse collapse">
        <div class="menu">
          <?php
            ...
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="index.php">INICIO</a></li>
              <li role="presentation"><a href="sobrenosotros">USUARIOS</a></li>
              <li role="presentation"><a href="vision.php">PRODUCTOS</a></li>
              <li role="presentation"><a href="informacion">INFORMACION</a></li>
              <li role="presentation"><a href="contactanos">DOCTORES</a></li>
              <li role="presentation"><a href="registro">RESPALDO DB</a></li>
              <li role="presentation"><a href="registro">RESTAURACION DB</a></li>
            </ul>
              <?php
            endif;
            ?>
